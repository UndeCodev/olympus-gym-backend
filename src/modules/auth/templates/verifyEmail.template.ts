export const getVerifyEmailTemplate = (url: string) => ({
  ...
  text: `Haga clic en el enlace para verificar su dirección de correo electrónico: ${url}`,
  html: `<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Verifica tu correo electrónico - Olympus GYM</title>
</head>
                ...
                <table role="presentation" style="width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            <h2 style="margin: 0 0 20px; color: #333333; font-size: 22px;">Verifica tu correo electrónico</h2>
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.5;">¡Hola!</p>
                            <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.5;">Gracias por registrarte en Olympus GYM. Para completar tu registro y comenzar tu camino hacia la excelencia física, por favor verifica tu correo electrónico haciendo clic en el botón de abajo:</p>
                            
                            <p style="margin: 30px 0; text-align: center;">
                                <a href="${url}" style="display: inline-block; padding: 12px 30px; background-color: #C52C38; color: #FFFFFF; text-decoration: none; font-weight: bold; font-size: 16px; border-radius: 4px; text-transform: uppercase;">Verificar Correo</a>
                            </p>
                            ...
                            <p style="margin: 30px 0 0; font-size: 16px; line-height: 1.5;">Si no solicitaste esta verificación, puedes ignorar este correo.</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px 30px; text-align: center; background-color: #f4f4f4; border-radius: 0 0 8px 8px; color: #666666; font-size: 14px;">
                            ...
                            <p style="margin: 0;">Calle Olimpo #123, Ciudad de los Dioses</p>
                        </td>
                    </tr>
                </table>
            </td>
